...
function docSize(){
  ...
  if(docwidth > '700'){
    $("#sidebarcontainer").css("height", docheight - 130 + "px");

    $("#contentcontainercontainer").css("width", (docwidth * .75) - 5 + "px");

    $("#sidebar").css("width", (docwidth * .25) - 20 + "px");    
  }
  else{
    $("#contentcontainercontainer").css("width", docwidth - 10 + "px");
  }
}
